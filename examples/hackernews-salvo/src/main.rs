...
async fn main() {
    ...
    let router = Router::new()
        ...
        // All #[glory::server] functions (fetch_user / fetch_stories /
        // fetch_story in models.rs) are served by this one mount.
...
#[cfg(feature = "web-csr")]
fn main() {
    BrowserHolder::new().enable(BrowserAviator::new(views::route(), views::catch())).mount(App);
}
